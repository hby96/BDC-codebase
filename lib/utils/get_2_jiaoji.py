...
save_path = '/home/ecg/Documents/Dataset/Huawei_Big_Data/chusai/best'
...
start_path = '/home/ecg/Documents/Projects/HuaWei_Big_Data/Demo/order_destination_GPS_repaired_begin.csv'
...
for idx, port_csv_path in tqdm(enumerate(port_list)):
    if port_csv_path in start_list:
